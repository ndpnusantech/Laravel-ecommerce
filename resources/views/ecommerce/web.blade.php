                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="number" min="1900" max="{{ date('Y') }}" name="copy"
                        ...
                        <form action="{{ route('web.update', $web->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label for="" class="form-label">Nama</label>
                                        <input type="text" name="name" id="" value="{{ $web->name }}"
                                            class="form-control">
                                    </div>
                                    <div class="col-lg-12">
                                        <label for="" class="form-label">Email</label>
                                        <input type="email" name="email" id="" value="{{ $web->email }}"
                                            class="form-control">
                                    </div>
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" name="alamat" id="" value="{{ $web->alamat }}"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
